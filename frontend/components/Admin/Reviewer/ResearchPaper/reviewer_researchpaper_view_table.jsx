...
export default function  Reviewer_ResearchPaper_ViewTable(){
    ...
    function update(id, topic, university, purpose, team_leader, email, phone, document, description){
        ...
        window.location.href = "/update-rp"
    }

    function show(id, topic, university, purpose, team_leader, email, phone, document, description){
        reactLocalStorage.setObject("ViewResearch", [id, topic, university, purpose, team_leader, email, phone, document, description]);
    ...
    return(
        <div class="flex">
            <NAV/>
            <h3 className="text-center mb-3">View Research Paper Details</h3>
            <center>
            <div className="row col-2 mb-3">
                <a className="btn btn-md btn-outline-success" href="/addResearch">
            ...
            <table className="table table-responsive table-hover table-bordered ">
                ...
                {papers.map((paper, key) => {
                    ...
                    <tr style={{backgroundColor: '#EBF5FB'}}>
                        ...
                        <td className="text-light badge bg-dark"> {paper.status}</td>
                        <td>
                            <div className="row">
                                <div className="col-1">
