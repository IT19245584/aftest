...
export default function  Reviewer_Workshop_Edit_one(){
    ...
    return(
        <div className="container-responsive">
            ...
            <h4 className="text-center">Edit Workshop Details.</h4>
                                ...
                                <div className="col-md-12 text-light">
                                    ...
                                    <div className="mb-1 text-left">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input className="input-group form-control" id="document" name="document" rows="3" cols="50" value={document}
                                             onChange={(e)=>{
