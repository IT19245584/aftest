...
export default function  Reviewer_WorkShop_ViewTable(){
    ...
    function update(id, topic, organization, presenter, phone, email, qualification, platform, date, from_time, to_time, document, description){
        ...
        window.location.href = "/update-ws"
    }
    ...
    function show(id, topic, organization, presenter, phone, email, qualification, platform, date, from_time, to_time, document, description){
        reactLocalStorage.setObject("ViewWorkshop", [id, topic, organization, presenter, phone, email, qualification, platform, date, from_time, to_time, document, description]);
        window.location.href = "/viewWorkshop"
    }
    // function name
    //url
    return(
            <div className="container-responsive">
                <NAV/>
                <h3 className="text-center mb-3">View Workshop Details</h3>
                <center>
                <div className="row col-2 mb-3">
                    <a className="btn btn-md btn-outline-success" href="/addWorkshop">
                        <i className="fa fa-plus-square mx-2"></i>Add
                    </a>
                </div>
                </center>

                <table className="table table-responsive table-hover table-bordered" id="wsTable">
                        ...
                        <tr style={{backgroundColor: '#FEF9E7'}}>
                            ...
                            <td className="text-light badge bg-dark">{workshop.status}</td>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-1">
                                        <a onClick={() => update(
                                            workshop._id, workshop.topic, workshop.organization, workshop.presenter, workshop.phone, workshop.email, workshop.qualification, workshop.platform, workshop.date, workshop.from_time, workshop.to_time, workshop.document, workshop.description
                                            )} className="m-1">
