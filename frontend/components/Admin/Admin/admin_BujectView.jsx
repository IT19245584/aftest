...
export default function Admin_BujectView(){
   ...
   function summery(AIncome,AExpence){
     
     const newYearSummery = {
           AIncome, AExpence
     }

     axios.post("http://localhost:6060/admin_accept_budject/yearSummery",newYearSummery).then(() =>{
     
     Swal.fire({  
       title: "Success!",
       text: "Year Summery Added",
       icon: 'success',
       confirmButtonText: "OK",
       type: "success"}).then(okay => {
          if (okay) {
      ...
      Swal.fire({  
       title: "error!",
       text: "Already Have Year Summery",
       icon: 'error',
       confirmButtonText: "OK",
       type: "success"})
   });
   ...
   function pastData(){
        window.location.href = "/Admin_past_summaries";
   }
return (
            ...
            <div id="layoutSidenav_content">
                <main>
                       <div className="container-fluid px-4 pt-5 mt-3">
                           <h2 className="text-center text-uppercase text-dark">Budject Dashboard</h2>
                       </div>
                       <div>
                          ...
                          {budjects.map((budject,key) => (
                            ...
                            <div class="row">
                             ...
                             <div className="text-end">
                                ...
                                <button type="submit" onClick={() =>summery(budject.income, budject.expence)} className="btn btn-outline-primary fw-bold btn-sm">Add Year Summary </button>{' '}
                                <button type="submit" onClick={pastData}className="btn btn-outline-secondary fw-bold btn-sm">Past Summaries </button>
                            </div>
                            </div>
                            ))}
