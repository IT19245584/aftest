   ...
   <div className="container" style={{ marginTop: '5%' }}>
            ...
            <div className="col-md-14 col-sm-12" style={{ maxWidth: '70rem', margin: 'auto', padding: '10px' }}>
                <div style={{ height: '300px' }}>
                    ...
                    <br/>
                    <div className="text-center container">
                    <a href="https://docs.google.com/uc?export=download&id=1XSx2ao3RVXrSQ1ysp5YkYuB7PFsTcTkT"><button type="button" className="btn btn-orange  btn-sm" style={{ letterSpacing: '2px' }}>Downlode Templete for Workshops <i className="bi bi-arrow-right-circle-fill"></i></button></a>
                        </div>
                </div>
            </div>
