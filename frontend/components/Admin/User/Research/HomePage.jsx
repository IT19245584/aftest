   ...
   <div className="container" style={{ marginTop: '5%' }}>
            ...
            <div className="col-md-14 col-sm-12" style={{ maxWidth: '70rem', margin: 'auto', padding: '10px' }}>
                <div style={{ height: '300px' }}>
                    ...
                    <br/>
                    <div className="text-center container">
                    <a href="https://docs.google.com/uc?export=download&id=1-1-XhGbUvx2WNi1H3GC2-rEwWiatYiCw"><button type="button" className="btn btn-orange  btn-sm" style={{ letterSpacing: '2px' }}>Downlode Templete for Research Paper <i className="bi bi-arrow-right-circle-fill"></i></button></a>
                        </div>
                </div>
            </div>
   </div>
